  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-700 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-8">All Time's Queries</h1>
          ...
          <table className="min-w-full bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
            ...
            <tbody>
              {loading ? (
                ...
                data.map((row) => (
                  <tr key={row._id} className="hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                    {columns.map(col => (
                      <td key={col.key} className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        {col.key === 'createdAt'
